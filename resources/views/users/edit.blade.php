  ...
  <div class="bg-white border border-[#05727d]/20 rounded-2xl shadow-sm overflow-hidden">
    ...
    <form method="POST" action="{{ route('users.update', $user) }}" class="p-6 space-y-4 text-sm">
      ...
      <div class="grid md:grid-cols-2 gap-4">
        ...
        {{-- Password Baru --}}
        <div>
          <label class="block text-xs text-slate-600 mb-1">Password Baru (opsional)</label>
        ...
        {{-- Konfirmasi Password --}}
        <div>
          <label class="block text-xs text-slate-600 mb-1">Konfirmasi Password Baru</label>
