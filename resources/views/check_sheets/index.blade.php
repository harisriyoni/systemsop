...
@section('content')
<div
  x-data="{ openCreate: {{ $errors->any() ? 'true' : 'false' }} }"
...
>
        ...
        @empty
          <tr>
            <td colspan="6" class="px-4 py-10 text-center">
              <div class="text-sm font-semibold text-slate-700 mb-1">Belum ada form check sheet</div>
  ...
  {{-- ================= MODAL CREATE FORM (PUTIH-BIRU, RESPONSIF) ================= --}}
  <div
    x-show="openCreate"
  ...
  >
    ...
    <div class="relative w-full max-w-2xl bg-white rounded-2xl border border-blue-100 shadow-2xl overflow-hidden">
      ...
      <div class="p-6 space-y-4">
        ...
        <form method="POST" action="{{ route('check_sheets.store') }}" class="space-y-4">
          @csrf
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {{-- Deskripsi --}}
            <div class="md:col-span-2">
              <label class="block text-xs text-slate-600 mb-1">Deskripsi / Instruksi Singkat (Opsional)</label>
