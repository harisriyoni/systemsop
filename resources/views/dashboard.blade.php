...
{{-- =========================
  HEADER / HERO
========================= --}}
<div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-[#05727d] via-[#05727d] to-[#05727d] text-white p-6 md:p-7 shadow-sm">
  ...
  <div class="relative flex flex-col md:flex-row md:items-center md:justify-between gap-4">
    ...
    <div class="flex flex-wrap gap-2">
      ...
      <a href="{{ route('qr_center.index') }}"
        class="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white text-[#05727d] hover:bg-[#05727d]/10 text-sm font-semibold transition shadow-sm">
        <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<div class="mt-5 bg-white rounded-2xl border border-[#05727d] shadow-sm p-5">
  <div class="flex items-center justify-between mb-3">
    ...
    <a href="{{ route('dashboard') }}" class="text-xs text-slate-500 hover:text-[#05727d] font-semibold">
      Reset filter
    </a>
  </div>
  ...
  <form method="GET" action="{{ route('dashboard') }}" class="grid gap-3 md:grid-cols-4 text-xs">
    <div>
      ...
      <input type="date" name="date" value="{{ $filters['date'] ?? '' }}"
        class="w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5
                    focus:ring-4 focus:ring-[#05727d] focus:border-[#05727d] outline-none transition">
    </div>
    ...
    <div class="md:col-span-4 flex justify-end gap-2 pt-1">
      <button class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#05727d] hover:bg-[#05727d] text-white text-xs font-semibold shadow-sm transition">
        <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<div class="mt-5 grid grid-cols-1 lg:grid-cols-3 gap-4">
  ...
  {{-- KPI SOP --}}
  <div class="bg-white rounded-2xl border border-[#05727d] shadow-sm p-5">
    <div class="flex items-start justify-between">
      ...
      <div class="h-10 w-10 rounded-xl bg-[#05727d]/10 text-[#05727d] grid place-items-center">
    ...
    <div class="mt-3 flex items-end justify-between">
      ...
      <a href="{{ route('sop.index') }}"
        class="text-xs text-[#05727d] hover:text-[#05727d] font-semibold">
        Lihat detail →
      </a>
    </div>
    ...
    <div class="mt-4 grid grid-cols-2 gap-2 text-xs">
      ...
      <div class="rounded-xl bg-[#05727d] px-3 py-2 flex justify-between">
        <span class="text-slate-500">Waiting</span>
        <span class="font-semibold text-[#05727d]">{{ $sop['waiting'] ?? 0 }}</span>
      </div>
      <div class="rounded-xl bg-[#05727d]/60 px-3 py-2 flex justify-between">
        <span class="text-slate-500">Approved</span>
        <span class="font-semibold text-[#05727d]">{{ $sop['approved'] ?? 0 }}</span>
      </div>
      <div class="rounded-xl bg-slate-50 px-3 py-2 flex justify-between">
  ...
  <div class="bg-white rounded-2xl border border-[#05727d] shadow-sm p-5">
    ...
    <div class="mt-4 space-y-2 text-xs">
      ...
      <div class="flex items-center justify-between rounded-xl bg-[#05727d]/10 px-3 py-2">
        <span class="text-slate-600">Under Review</span>
        <span class="font-semibold text-[#05727d]">{{ $checkSheetToday['underReview'] ?? 0 }}</span>
      </div>
      <div class="flex items-center justify-between rounded-xl bg-[#05727d]/60 px-3 py-2">
        <span class="text-slate-600">Approved</span>
        <span class="font-semibold text-[#05727d]">{{ $checkSheetToday['approved'] ?? 0 }}</span>
      </div>
      <div class="flex items-center justify-between rounded-xl bg-slate-50 px-3 py-2">
    ...
    <div class="mt-4 space-y-2 text-xs">
      <div class="flex items-center justify-between rounded-xl bg-[#05727d]/10 px-3 py-2">
        <div class="flex items-center gap-2">
          <span class="w-2 h-2 bg-[#05727d] rounded-full"></span>
          <span class="text-slate-700">SOP pending QA</span>
        </div>
        <span class="font-semibold text-[#05727d]">{{ $needAction['sop_pending_qa'] ?? 0 }}</span>
      </div>
      ...
      <div class="flex items-center justify-between rounded-xl bg-[#05727d]/10 px-3 py-2">
        ...
        <span class="font-semibold text-[#05727d]">{{ $needAction['cs_pending_logistik'] ?? 0 }}</span>
      </div>
      ...
      <div class="pt-2">
        <div class="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
          ...
          @endphp
          <div class="h-full bg-gradient-to-r from-[#05727d] to-[#05727d]" style="width: {{ $progress }}%"></div>
        </div>
...
<div class="mt-5 grid grid-cols-1 lg:grid-cols-3 gap-4">
  ...
  <div class="bg-white rounded-2xl border border-[#05727d] shadow-sm p-5">
    <div class="flex items-center justify-between mb-2">
      ...
      <div class="text-[11px] px-2 py-1 bg-[#05727d]/10 text-[#05727d] rounded-lg">30 hari terakhir</div>
    </div>
  ...
  <div class="bg-white rounded-2xl border border-[#05727d] shadow-sm p-5">
    <div class="flex items-center justify-between mb-2">
      ...
      <div class="text-[11px] px-2 py-1 bg-[#05727d]/10 text-[#05727d] rounded-lg">harian</div>
    </div>
  ...
  <div class="bg-white rounded-2xl border border-[#05727d] shadow-sm p-5">
    <div class="flex items-center justify-between mb-2">
      ...
      <div class="text-[11px] px-2 py-1 bg-[#05727d]/10 text-[#05727d] rounded-lg">pending</div>
    </div>
    ...
    new Chart(document.getElementById('sopStatusChart'), {
      ...
      data: {
        ...
        datasets: [{
          ...
          backgroundColor: ['#e2e8f0', '#05727d', '#05727d', '#cbd5e1'],
          borderWidth: 0,
          hoverOffset: 4
        }]
      },
  ...
  if (hasCsData) {
    ...
    new Chart(document.getElementById('csTodayChart'), {
      ...
      data: {
        ...
        datasets: [{
          data: csVals,
          backgroundColor: ['#05727d', '#05727d', '#05727d', '#e2e8f0'],
          borderRadius: 10,
          borderSkipped: false
        }]
      },
