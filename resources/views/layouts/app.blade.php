...
<body class="bg-slate-50 min-h-screen text-slate-800">
    <div x-data="{ mobileOpen: false, collapsed: false }" class="min-h-screen flex">
        ...
        <!-- OVERLAY MOBILE -->
        <div x-show="mobileOpen" x-transition.opacity class="fixed inset-0 bg-black/40 z-40 md:hidden"
            @click="mobileOpen=false" style="display:none;"></div>
        ...
        <aside
            ...
            <div class="px-4 py-4 border-b border-slate-200 bg-gradient-to-r from-[#05727d] to-[#04616a] text-white">
                <div class="flex items-center justify-between">
                    ...
                    <button class="hidden md:inline-flex p-2 rounded-lg hover:bg-white/10" @click="collapsed=!collapsed"
                        :title="collapsed ? 'Expand sidebar' : 'Collapse sidebar'">
                        <svg x-show="!collapsed" class="w-5 h-5" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" />
                        </svg>
                        <svg x-show="collapsed" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor"
            ...
            <nav class="flex-1 px-2 py-3 space-y-1 text-sm overflow-y-auto sidebar-scroll">
                ...
                {{-- PROFILE GROUP --}}
                <div class="mt-4 px-3 text-[11px] uppercase text-slate-400 tracking-wider flex items-center gap-2"
                    x-show="!collapsed">
                    <span>Account</span>
               ...
               {{ request()->routeIs('sop.index', 'sop.show', 'sop.edit')
                   ...
                   {{ request()->routeIs('sop.templates.*') && !request()->routeIs('sop.templates.create')
                       ...
                       : 'text-slate-700 hover:bg-[#e6f1f2] hover:text-[#045058]' }}">
                        ...
                        {{ request()->routeIs('sop.templates.*') && !request()->routeIs('sop.templates.create')
                            ...
                            <svg class="w-4 h-4 opacity-90" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <button type="button" onclick="window.location='{{ $versionsUrl }}'"
                ...
                <button type="button" onclick="window.location='{{ $historyUrl }}'"
                    class="group w-full flex items-center gap-3 px-3 py-2 rounded-xl transition ml-3 text-left
        ...
        <main class="flex-1 min-w-0">
            ...
            <!-- TOPBAR -->
            <header
                class="h-14 bg-white border-b border-slate-200 flex items-center justify-between px-4 md:px-6 sticky top-0 z-30">
                <div class="flex items-center gap-3">
                    <!-- Hamburger (mobile) -->
                    <button class="md:hidden p-2 rounded-lg hover:bg-slate-100 text-[#05727d]"
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        <button @click="open=!open" @click.outside="open=false"
                            ...
                            @else
                                <div
                                    class="h-9 w-9 rounded-full bg-[#cde3e5] text-[#045058] grid place-items-center font-bold">
                            ...
                            <svg class="hidden md:block w-4 h-4 text-slate-500" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2">
